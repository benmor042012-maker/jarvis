...
function isAllowed(action, mode) {
  ...
  if (mode === "safe" && level > LEVELS.SAFE) return { allowed: false, reason: "safe_mode", needsApproval: level !== LEVELS.BLOCKED };
...
module.exports = { LEVELS, ACTION_LEVELS, getLevel, isAllowed, levelLabel };
